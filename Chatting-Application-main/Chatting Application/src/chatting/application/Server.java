...
import java.io.*;
    ...
    public class Server implements ActionListener {
        ...
        Server() {
           ...
           JLabel name = new JLabel("Sinha Ji");
...
//            });
        ...
        public static void main(String[] args){
           ...
           // The printStackTrace method in Java is used to
           // print the stack trace of a Throwable (which includes exceptions and errors) to the standard error stream.  
          
            try {
                ServerSocket skt = new ServerSocket(6001);
                 
                // server ko infinite chlana h, saare msg ko accept krna h
                while(true) {
                    //client se kuch aata h tb socket accept kre ga
                    Socket s = skt.accept();
                    
                    //msg receive krna h tb 
                    DataInputStream din = new DataInputStream(s.getInputStream());
                    
                    // msg send krna h
                    // esko action perform fn use krne h 
                    // tb esko globally declare krna pde ga
